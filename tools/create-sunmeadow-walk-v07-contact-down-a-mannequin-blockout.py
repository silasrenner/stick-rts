...
OUT_DIR = ROOT / "assets/art/runtime-candidates/sunmeadow/warrior/sunmeadow-warrior-walk-v07-contact-down-a-mannequin-blockout"
ASE = ROOT / "assets/art/editable/sunmeadow/warrior/sunmeadow-warrior-walk-v07-contact-down-a-mannequin-blockout.aseprite"
LUA = ROOT / "tools/create-sunmeadow-walk-v07-contact-down-a-mannequin-blockout.lua"
BOARD = ROOT / "artifacts/warrior-pair-proof/sunmeadow-walk-v07-contact-a-down-a-mannequin-blockout.png"
...
# Down A: both feet retain Contact A's planted endpoints. Hips, torso and head
# descend 2px. Knees fold in/down toward their own planted foot rather than
# forming a crossed X or an outward rigid V.
# Rear leg: right foot remains planted, knee folds toward that foot.
d.polygon([(53, 63), (61, 66), (68, 79), (76, 87), (76, 90), (66, 90), (61, 84), (56, 77), (50, 68)], fill=DARK)
# Front leg: left foot remains planted, knee carries the visible compression.
d.polygon([(48, 63), (55, 67), (46, 78), (36, 88), (34, 90), (23, 90), (29, 84), (38, 73), (42, 66)], fill=DARK)
...
bd.text((16, 14), "SUNMEADOW WALK v07 — CONTACT A / DOWN A MANNEQUIN BLOCKOUT", fill="#F8FAFC")
