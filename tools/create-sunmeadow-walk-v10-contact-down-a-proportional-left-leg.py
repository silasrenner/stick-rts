...
OUT_DIR = ROOT / "assets/art/runtime-candidates/sunmeadow/warrior/sunmeadow-warrior-walk-v10-contact-down-a-mannequin-blockout"
ASE = ROOT / "assets/art/editable/sunmeadow/warrior/sunmeadow-warrior-walk-v10-contact-down-a-mannequin-blockout.aseprite"
LUA = ROOT / "tools/create-sunmeadow-walk-v10-contact-down-a-mannequin-blockout.lua"
BOARD = ROOT / "artifacts/warrior-pair-proof/sunmeadow-walk-v10-contact-a-down-a-proportional-left-leg.png"
...
def limb(points, width=10):
    radius = width // 2
    d.line(points, fill=DARK, width=width, joint="curve")
    for x, y in points:
        d.ellipse((x - radius, y - radius, x + radius, y + radius), fill=DARK)

limb([(57, 60), (67, 79), (72, 90)])
# Keep the knee articulation, but pull it back toward the body and use a
# slimmer front-leg mass. The knee remains forward of the planted foot.
limb([(47, 60), (31, 77), (27, 90)], width=8)
...
bd.text((16, 14), "SUNMEADOW WALK v10 — CONTACT A / DOWN A PROPORTIONAL LEFT LEG", fill="#F8FAFC")
