...
OUT_DIR = ROOT / "assets/art/runtime-candidates/sunmeadow/warrior/sunmeadow-warrior-walk-layout-v03"
EDITABLE = ROOT / "assets/art/editable/sunmeadow/warrior/sunmeadow-warrior-walk-layout-v03.aseprite"
CONTACT = ROOT / "artifacts/warrior-pair-proof/sunmeadow-walk-layout-v03-four-poses.png"
...
POSES = (
    # Contact A: legs form a wide V; the front/right leg plants forward.
    ("1 — CONTACT A", 0,
     [(42, 64), (50, 64), (44, 76), (34, 90), (25, 90), (36, 74)],
     [(56, 64), (63, 64), (70, 76), (83, 90), (73, 90), (58, 75)]),
    # Passing A: left leg supports, right leg is clearly lifted and folded.
    ("2 — PASSING A", 1,
     [(42, 65), (50, 65), (48, 78), (45, 90), (36, 90), (38, 76)],
     [(56, 65), (63, 65), (69, 73), (68, 80), (58, 84), (54, 77)]),
    # Contact B: legs cross from opposite hips, switching which leg owns the forward plant.
    ("3 — CONTACT B", 0,
     [(42, 64), (50, 64), (57, 75), (73, 90), (83, 90), (62, 76)],
     [(56, 64), (63, 64), (55, 76), (34, 90), (25, 90), (47, 75)]),
    # Passing B: right leg supports, left leg is clearly lifted and folded.
    ("4 — PASSING B", 1,
     [(42, 65), (50, 65), (42, 73), (43, 80), (53, 84), (55, 77)],
...
gif = OUT_DIR / "sunmeadow-warrior-walk-layout-v03.gif"
...
d.text((16, 14), "SUNMEADOW WALK LAYOUT v03 — REVISED FLAT FOUR-POSE GATE", fill="#F8FAFC")
