...
OUT_DIR = ROOT / "assets/art/runtime-candidates/sunmeadow/warrior/sunmeadow-warrior-walk-v08-contact-down-a-mannequin-blockout"
ASE = ROOT / "assets/art/editable/sunmeadow/warrior/sunmeadow-warrior-walk-v08-contact-down-a-mannequin-blockout.aseprite"
LUA = ROOT / "tools/create-sunmeadow-walk-v08-contact-down-a-mannequin-blockout.lua"
BOARD = ROOT / "artifacts/warrior-pair-proof/sunmeadow-walk-v08-contact-a-down-a-guide-aligned-blockout.png"
...
bd.text((16, 14), "SUNMEADOW WALK v08 — CONTACT A / DOWN A GUIDE-ALIGNED MANNEQUIN BLOCKOUT", fill="#F8FAFC")
