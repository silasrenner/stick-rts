...
OUT = ROOT / "assets/art/runtime-candidates/sunmeadow/warrior/sunmeadow-warrior-walk-v11-contact-down-passing-a-mannequin-blockout"
ASE = ROOT / "assets/art/editable/sunmeadow/warrior/sunmeadow-warrior-walk-v11-contact-down-passing-a-mannequin-blockout.aseprite"
LUA = ROOT / "tools/create-sunmeadow-walk-v11-contact-down-passing-a-mannequin-blockout.lua"
BOARD = ROOT / "artifacts/warrior-pair-proof/sunmeadow-walk-v11-guide-vs-mannequin-contact-down-passing-a.png"
...
# Passing A follows saved guide frame 03: the screen-right/central leg supports
# at y=90, while the screen-left leg folds up and clears the ground.
limb([(55, 60), (50, 75), (52, 90)], 9)       # planted support leg
# The raised leg needs a visible folded knee rather than a single diagonal mass:
# hip → forward knee → lifted horizontal foot. It remains clear of ground.
limb([(48, 60), (36, 72), (32, 82)], 7)
d.rectangle((26, 79, 36, 84), fill=DARK)       # raised foot; remains 6px above ground
...
bd.text((16, 14), "SUNMEADOW WALK v11 — GUIDE vs MANNEQUIN BLOCKOUT", fill="#F8FAFC")
